...
export async function execute(interaction: ChatInputCommandInteraction): Promise<void> {
  ...
  const everyoneSection =
    ...
    '`/games` — pick which games you want View access and LFG pings for\n' +
    '`/play <game>` — post an LFG ping for a game (autocomplete; rate-limited)\n' +
  ...
  const sudoSection =
    ...
    'Right-click a member → **Manage User** — Edit Profile, Game Prefs, voice status, disconnect, staff history\n\n' +
    '### 🧵 Automatic\n' +
